    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4 px-1">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto flex-1">
          {/* Title (if any) */}
          {title && (
            <h2 className="text-sm font-black text-[#111f42] uppercase tracking-[0.2em] mr-2">
              {title}
            </h2>
          )}
            ...
            <>
              <div className="relative group">
                <select
                  ...
                  className="appearance-none bg-white border border-slate-200 rounded-xl pl-4 pr-10 py-1.5 text-[11px] font-black uppercase tracking-widest text-[#111f42] outline-none focus:border-[#111f42] transition-all h-10 cursor-pointer shadow-sm min-w-[130px]"
                >
              ...
              <div className="relative group">
                <select
                  ...
                  className="appearance-none bg-white border border-slate-200 rounded-xl pl-4 pr-10 py-1.5 text-[11px] font-black uppercase tracking-widest text-[#111f42] outline-none focus:border-[#111f42] transition-all h-10 cursor-pointer shadow-sm min-w-[110px]"
                >
              ...
              <div className="hidden md:block w-px h-6 bg-slate-200 self-center mx-1"></div>
            </>
          )}
              ...
              <div key={colId} className="flex items-center gap-2">
                <div className="relative group">
                  <select
                    ...
                    className="appearance-none bg-white border border-slate-200 rounded-xl pl-4 pr-10 py-1.5 text-[11px] font-black uppercase tracking-widest text-[#111f42] outline-none focus:border-[#111f42] transition-all h-10 cursor-pointer shadow-sm min-w-[140px]"
                  >
          ...
          {columnFilters.length > 0 && (
            <button
              ...
              className="text-[10px] font-black text-rose-500 uppercase tracking-widest hover:underline px-2 transition-all h-10"
            >
              Clear All
            </button>
          )}
        ...
        {/* RIGHT SIDE: Action Buttons & Export */}
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto shrink-0 justify-end">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white text-[#111f42] rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-50 transition-all h-10 border border-slate-200 shadow-sm whitespace-nowrap"
          >
            <Download size={14} />
            Export
          </button>
      ...
      <div className="bg-white rounded-xl border-t border-b sm:border border-slate-200 shadow-sm sm:rounded-2xl overflow-hidden min-h-[400px] flex flex-col">
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/30 flex flex-col sm:flex-row items-center justify-between gap-4 rounded-none">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative group">
                <select
                  ...
                  className="appearance-none bg-white border border-slate-200 rounded-lg pl-3 pr-8 py-1.5 text-[11px] font-black uppercase tracking-widest text-[#111f42] outline-none focus:border-[#111f42] transition-all h-8 cursor-pointer shadow-sm"
                >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center px-3 text-[11px] font-black text-[#111f42] uppercase tracking-[0.2em]">
