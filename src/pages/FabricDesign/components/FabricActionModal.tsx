  ...
  return (
    <div className="modal-overlay open" onClick={onClose}>
      <div className="modal-box border-t-[6px] border-[#ab8a3b] max-w-3xl" onClick={e => e.stopPropagation()}>
        <div className="px-8 py-5 bg-[#111f42] border-b border-slate-100 flex justify-between items-center shrink-0">
        ...
        <div className="flex-1 overflow-y-auto master-custom-scrollbar p-8 bg-[#F9F7F6]">
          {isConfigMode ? (
            <div className="bg-white p-8 rounded-2xl border border-slate-200 max-w-lg mx-auto shadow-sm">
            ...
            <div className="space-y-6 animate-fade-in-up">
              ...
              {activeTab === 'info' && (
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                  ...
                  <div className="md:col-span-8 grid grid-cols-2 gap-x-5 gap-y-5 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-fit">
        ...
        {!isConfigMode && (
          <div className="p-6 border-t border-slate-200 bg-slate-50 flex justify-between items-center shrink-0 rounded-b-2xl">
            ...
            <button onClick={onSave} className="px-10 py-3 bg-[#111f42] text-[#ab8a3b] text-[11px] font-black rounded-xl shadow-lg shadow-[#111f42]/20 hover:brightness-110 transition-all flex items-center gap-2 uppercase tracking-widest font-mono">
