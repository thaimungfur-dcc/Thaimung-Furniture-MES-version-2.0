        ...
        <div className="modal-overlay z-[50000]" onClick={closeModal}>
            ...
            <DraggableWrapper>
                  <div className="bg-white rounded-[2rem] border-t-[6px] border-[#ab8a3b] w-full max-w-2xl shadow-2xl flex flex-col animate-in zoom-in-95 duration-300 max-h-[85vh]" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="flex-1 overflow-y-auto master-custom-scrollbar p-4 sm:p-5 bg-[#F9F7F6] space-y-4">
                                <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-sm space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="number" value={form.qty} onChange={e => setForm({...form, qty: e.target.value})} className="input-primary text-right font-black text-2xl h-10 font-mono border-[#ab8a3b]/40 focus:border-[#ab8a3b]" />
                                        </div>
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="text" value={form.location} onChange={e => setForm({...form, location: e.target.value})} className="input-primary h-10 font-mono uppercase font-bold" placeholder="WH-X-00" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="p-4 sm:p-5 bg-white border-t flex justify-end gap-3 rounded-b-2xl shrink-0 px-5">
                                ...
                                <button onClick={() => submitBooking(true)} className="bg-[#E3624A] text-white px-5 py-2.5 rounded-xl font-black text-[11px] uppercase tracking-widest shadow-lg shadow-[#E3624A]/20 hover:brightness-110 transition-all flex items-center gap-2 font-mono h-11"><CheckCircle size={16} /> FINALIZE BOOKING</button>
                            </div>
                        </div>
                </DraggableWrapper>
