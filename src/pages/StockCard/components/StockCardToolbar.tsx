      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-end">
        <div className="md:col-span-5 relative" ref={dropdownRef}>
          ...
          <div className="relative h-10 group">
            <Search size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#111f42] transition-colors" />
            <input 
              type="text" 
              ...
              className="w-full h-full bg-white border-2 border-slate-200 rounded-xl pl-10 pr-10 text-[10px] font-black uppercase tracking-widest text-[#111f42] outline-none focus:border-[#111f42] transition-all shadow-sm placeholder:opacity-40"
            />
            {itemSearchText && (
        ...
        <div className="md:col-span-3">
          ...
          <div className="relative h-10 group">
            <Filter size={12} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#111f42] transition-colors" />
            <select 
        ...
        <div className="md:col-span-4 flex justify-end gap-2">
          <button onClick={onExportClick} className="h-10 px-8 rounded-xl bg-[#111f42] text-white text-[10px] font-black uppercase tracking-[0.2em] shadow-xl hover:bg-[#0a1229] transition-all flex items-center gap-3 font-mono">
