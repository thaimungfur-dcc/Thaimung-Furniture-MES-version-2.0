  ...
  return (
    <div className="fixed inset-0 bg-[#223149]/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 print:p-0 no-print">
      <div className="bg-white rounded-2xl w-full max-w-[1100px] shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in duration-200 max-h-[90vh] print:max-h-none print:shadow-none print:rounded-none">
        <div className={`px-6 py-4 flex justify-between items-center text-white no-print bg-[#df8a5d]`}>
        ...
        <div className="p-4 md:p-6 overflow-y-auto flex-1 bg-[#eee5ca] flex justify-center print:bg-white print:overflow-visible print:p-0">
          <div className="bg-white p-6 md:p-8 shadow-md w-full max-w-[1123px] min-h-[794px] h-max flex flex-col print:shadow-none print:max-w-none print:w-auto print:min-h-0 print:p-0 mx-auto print:mx-0 text-slate-800">
