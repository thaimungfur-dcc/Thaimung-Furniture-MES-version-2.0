    ...
    <div className="modal-overlay open" onClick={onClose}>
          ...
          <DraggableWrapper>
                <div className="modal-box p-0 max-w-[1000px] border-t-[6px] border-[#ab8a3b] rounded-[16px]" onClick={e => e.stopPropagation()}>
                  <div className="bg-[#111f42] px-5 py-5 flex justify-between items-center text-white shrink-0">
                  ...
                  <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto wh-custom-scrollbar p-5 bg-[#F9F7F6]">
                      {activeTab === 'info' && (
                        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 animate-fade-in-up">
                  ...
                  <div className="p-4 sm:p-5 bg-slate-50 border-t border-slate-200 flex justify-between items-center px-5 rounded-b-2xl">
                    ...
                    <button onClick={onSave} className="bg-[#111f42] text-[#ab8a3b] px-6 py-3 rounded-xl font-black uppercase text-[11px] shadow-lg shadow-[#111f42]/20 hover:brightness-110 transition-all flex items-center gap-2 font-mono">
