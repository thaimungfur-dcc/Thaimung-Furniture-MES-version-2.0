    ...
    <div className="fixed inset-0 bg-[#111f42]/60 backdrop-blur-md z-[100] flex items-center justify-center p-4 animate-in zoom-in duration-200">
          ...
          <DraggableWrapper>
                <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh] border-t-[6px] border-[#ab8a3b]">
                  ...
                  <div className="flex-1 overflow-y-auto p-5 custom-scrollbar space-y-5 bg-[#F9F7F6]">
                  ...
                  <div className="p-4 sm:p-5 bg-slate-50 border-t border-slate-200 flex justify-end">
                    <button onClick={() => setConfigModalOpen(false)} className="bg-[#111f42] text-[#ab8a3b] px-6 py-3 rounded-xl font-black text-[11px] uppercase tracking-widest shadow-md hover:bg-[#1a2d5c] transition-all font-mono">Done / Save Master</button>
                  </div>
                </div>
              </DraggableWrapper>
