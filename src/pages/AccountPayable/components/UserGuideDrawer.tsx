    ...
    <div className="fixed inset-0 z-[60] flex justify-end no-print">
      ...
      <div className="relative w-full max-w-md h-full bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-300 border-l border-white/20">
        ...
        <div>
          ...
          <p className="leading-relaxed font-medium mb-2">ระบบจัดการฐานข้อมูลเจ้าหนี้ (Database) นี้ เน้นไปที่ <strong>การปฏิบัติงานรายวัน (Operation)</strong> สำหรับการตรวจสอบการจ่ายเงินและติดตามบิล</p>
          <div className="bg-emerald-50 border border-emerald-200 p-3 rounded-xl flex items-start gap-3 text-emerald-800 shadow-sm mt-3">
            ...
            <div className="flex-1 min-w-0 mt-0.5">
               <p className="text-[11px] font-bold tracking-wide leading-relaxed">
                 ...
                 ข้อมูลทั้งหมดในหน้านี้ซิงค์มาจาก Master Data Center โดยตรง เพื่อป้องกันข้อผิดพลาด <span className="text-rose-600 font-black underline">ไม่อนุญาตให้เพิ่มบิลใหม่ในหน้านี้</span>
               </p>
            </div>
          </div>
        </div>
        ...
        <div>
            <h3 className="text-sm font-black text-[#223149] border-b-2 border-[#df8a5d]/30 pb-2 mb-3 flex items-center gap-2"><FileText size={16} className="text-[#ce5a43]"/> 2. มุมมองตารางแบบละเอียด (DETAILED BILLS)</h3>
            <ul className="list-disc pl-5 space-y-1.5 marker:text-[#df8a5d] font-medium text-[12px]">
              <li>แสดงข้อมูลครบถ้วนทั้งวันที่ตั้งเบิก (Issue Date) และวันครบกำหนด (Due Date) สำหรับใช้คำนวณ DPO</li>
              <li>แสดงเครดิตเทอม และประเภทผู้จำหน่าย (Critical / Contract / Spot) สำหรับวิเคราะห์ความเสี่ยง</li>
              <li>สามารถคลิก <strong>Mark Disputed</strong> เพื่อแท็กว่าบิลก้อนนี้อยู่ในระหว่างการเจรจา (ระงับการจ่ายเงิน)</li>
            </ul>
          </div>

          <div>
            <h3 className="text-sm font-black text-[#223149] border-b-2 border-[#df8a5d]/30 pb-2 mb-3 flex items-center gap-2"><CreditCard size={16} className="text-[#ce5a43]"/> 3. การบันทึกจ่ายเงิน (Pay)</h3>
            <ul className="list-disc pl-5 space-y-1.5 marker:text-[#df8a5d] font-medium text-[12px]">
              <li>คลิก <strong>Pay</strong> บนการ์ดใดๆ เพื่อทำการบันทึกการโอนเงิน/ชำระเงินตัดยอดหนี้</li>
              <li>ระบบจะบันทึกวันที่จ่ายเงินจริง (Pay Date) ทันทีที่จ่ายครบ ซึ่งเป็นหัวใจสำคัญในการคำนวณ On-Time Payment Rate และ DPO</li>
            </ul>
          </div>
        </div>
