    ...
    return (
        <div className="modal-overlay" onClick={closeModal}>
            <div className="modal-box max-w-[850px] border-t-[8px] border-[#ab8a3b] rounded-none animate-fade-in-up shadow-[0_0_50px_rgba(0,0,0,0.3)]" onClick={e => e.stopPropagation()}>
                <div className="bg-[#111f42] px-8 py-6 flex justify-between items-center text-white shrink-0 border-b border-[#ab8a3b]/30">
                    <div>
                ...
                <div className="p-8 overflow-y-auto master-custom-scrollbar flex-1 space-y-8 bg-[#f5f0e9]">
                    {/* 1. General Information Section */}
                    <div className="bg-white p-8 rounded-none shadow-[4px_4px_0px_#e2e8f0] border-2 border-[#111f42]/10 border-l-[6px] border-l-[#111f42]">
                    ...
                    <div className="bg-white p-8 rounded-none shadow-[4px_4px_0px_#e2e8f0] border-2 border-[#111f42]/10 border-l-[6px] border-l-[#ab8a3b]">
                        <h4 className="text-[12px] font-black text-[#111f42] uppercase tracking-[0.2em] mb-6 flex items-center gap-3">
                ...
                <div className="p-8 border-t-2 border-[#111f42]/10 bg-white flex justify-end gap-4 shrink-0 shadow-[0_-10px_30px_rgba(0,0,0,0.02)]">
                    <button onClick={closeModal} className="px-8 py-3 text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-none transition-all border-2 border-transparent">Cancel</button>
