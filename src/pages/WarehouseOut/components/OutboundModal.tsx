    ...
    return (
        <div className="modal-overlay open" style={{zIndex: 10001}} onClick={onClose}>
            <div className={`modal-box border-b-8 border-[#ab8a3b] shadow-2xl transition-all w-full overflow-hidden rounded-none ${type === 'MANUAL' ? 'max-w-5xl' : 'max-w-2xl'}`} onClick={e => e.stopPropagation()}>
                <div className="p-8 bg-[#111f42] text-white flex justify-between items-center shrink-0">
                    <div className="flex items-center gap-6">
                        <div className="w-14 h-14 bg-white/5 border border-white/10 flex items-center justify-center rounded-none shadow-inner text-[#ab8a3b]">
                ...
                <div className="flex-1 overflow-y-auto master-custom-scrollbar p-10 bg-[#f8fafc]">
                     {type !== 'MANUAL' && !editingId && (
                         <div className="bg-white p-8 border-2 border-slate-100 shadow-sm mb-8 flex justify-between items-center animate-fade-in-up rounded-none">
                             <div>
                     ...
                     <div className="bg-white p-8 border-2 border-slate-100 shadow-sm space-y-8 animate-fade-in-up rounded-none">
                ...
                <div className="p-8 border-t bg-slate-50 flex justify-between gap-6 shrink-0 z-10 rounded-none items-center">
                     <button onClick={onClose} className="px-8 py-4 text-slate-500 hover:text-[#111f42] text-[12px] font-black hover:bg-slate-200 rounded-none transition-all uppercase tracking-[0.2em] font-mono border border-transparent hover:border-slate-300">Close Form</button>
                     <div className="flex gap-4">
                         <button onClick={() => onSubmit(false)} className="px-10 py-4 bg-white border-2 border-[#111f42] text-[#111f42] hover:bg-slate-50 text-[12px] font-black rounded-none shadow-sm transition-all flex items-center gap-3 uppercase tracking-[0.2em] font-mono">
                             <Save size={18} /> {editingId ? 'Update Log' : (type === 'MANUAL' ? 'Process Batch' : 'Commit Partial')}
                         </button>
                         {type !== 'MANUAL' && !editingId && (
                             <button onClick={() => onSubmit(true)} className="px-10 py-4 bg-[#ab8a3b] hover:bg-[#8f712c] text-white text-[12px] font-black rounded-none shadow-2xl shadow-[#ab8a3b]/20 transition-all flex items-center gap-3 uppercase tracking-[0.2em] font-mono border-b-4 border-[#8f712c]">
