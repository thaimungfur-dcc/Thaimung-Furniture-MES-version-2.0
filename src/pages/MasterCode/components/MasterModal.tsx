  ...
  return (
    <div className="modal-overlay open" onClick={closeModal}>
      <div className="modal-box p-0 max-w-[1000px] border-t-[6px] border-[#ab8a3b] rounded-[16px]" onClick={e => e.stopPropagation()}>
        <div className="bg-[#111f42] px-8 py-5 flex justify-between items-center">
          <div>
        ...
        <div className="p-8 overflow-y-auto master-custom-scrollbar bg-[#F9F7F6] flex-1 space-y-6 font-sans">
          {/* Groups */}
          <div>
          ...
          {isDuplicate && (
            <div className="bg-red-50 border border-red-200 text-red-600 px-5 py-4 rounded-xl flex items-center gap-4 text-xs font-medium animate-pulse shadow-sm">
        ...
        <div className="p-6 border-t border-slate-200 bg-white flex justify-between items-center shrink-0">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={saveItem} disabled={!isValid || isDuplicate} 
              className={`px-8 py-3 text-[11px] font-black rounded-xl flex items-center gap-2 tracking-widest uppercase transition-all font-mono ${(!isValid || isDuplicate) ? 'bg-slate-100 text-slate-400 cursor-not-allowed' : 'bg-[#ab8a3b] text-white hover:bg-[#917532] shadow-md shadow-[#ab8a3b]/30'}`}>
