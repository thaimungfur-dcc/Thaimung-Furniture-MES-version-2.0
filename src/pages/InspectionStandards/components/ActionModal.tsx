    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            ...
            >
                ...
                <div className="p-6 bg-[#F9F7F6] overflow-y-auto master-custom-scrollbar space-y-5 flex-1">
                    {modalMode === 'product' ? (
                    ...
                    <div className="mt-2">
                        ...
                        >
                            {(modalMode === 'product' ? productForm.image : standardForm.image) ? (
                                ...
                                <div className="text-slate-300 py-4 flex flex-col items-center gap-1">
                ...
                <div className="p-5 border-t border-slate-200 bg-white flex justify-between items-center rounded-b-2xl shrink-0">
                    ...
                    <button 
                        onClick={onSave} 
                        className="bg-[#111f42] text-[#ab8a3b] px-8 py-2.5 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-md hover:brightness-110 flex items-center gap-2 transition font-mono"
                    >
