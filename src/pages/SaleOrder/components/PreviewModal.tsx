  ...
  return (
    <div className="fixed inset-0 bg-[#111f42]/70 backdrop-blur-md z-[120] flex items-center justify-center p-4 print:p-0 no-print">
      <div className="bg-white rounded-[2.5rem] w-full max-w-4xl h-[90vh] flex flex-col print:h-auto overflow-hidden shadow-2xl">
        <div className="p-6 border-b flex justify-between items-center no-print bg-[#ab8a3b] text-white shrink-0">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-slate-100 print:bg-white flex justify-center print:p-0">
          <div className="bg-white p-8 w-full max-w-[794px] min-h-[1123px] h-max flex flex-col text-[11px] print:shadow-none shadow-xl border relative">
