...
export default function ConfigModal({
  ...
  return (
    <div className="fixed inset-0 bg-[#0f172a]/50 backdrop-blur-sm z-[110] flex items-center justify-center p-4">
          ...
          <DraggableWrapper>
                <div className="bg-white rounded-[3rem] w-full max-w-sm shadow-2xl p-4 sm:p-5 border border-white relative overflow-hidden">
                  ...
                  <div className="space-y-4 relative z-10">
                    ...
                    <div className="bg-[#111f42] p-4 sm:p-5 rounded-3xl text-center shadow-xl shadow-navy/20">
