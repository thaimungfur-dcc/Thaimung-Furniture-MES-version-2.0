...
export const NotificationModal = ({ isOpen, title, message, type, onClose }: any) => {
    ...
    return (
        <div className="fixed inset-0 z-[90000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center border-t-4 border-[#ab8a3b] animate-in zoom-in-95">
                <div className={`flex justify-center mb-4 ${colors[type] || 'text-slate-500'}`}>
                    {type === 'success' && <CheckCircle size={48} />}
