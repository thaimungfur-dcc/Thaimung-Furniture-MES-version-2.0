  ...
  return (
    <div className="fixed inset-0 bg-[#111f42]/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4 no-print animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl w-full max-w-5xl shadow-2xl overflow-hidden flex flex-col max-h-[95vh]">
        <div className="px-6 py-4 flex justify-between items-center bg-[#111f42] text-white shrink-0 border-b-4 border-[#E3624A]">
                  ...
                  <div className="overflow-x-auto max-h-[350px] custom-scrollbar">
                    <table className="w-full text-left data-table relative">
                      <thead className="bg-slate-100 text-slate-600 border-b border-slate-200 sticky top-0 z-10 shadow-sm">
                        <tr>
                          <th className="px-3 py-4 font-bold uppercase text-center w-12">No.</th>
                          <th className="px-3 py-4 font-bold uppercase min-w-[200px]">Description (รายการสินค้า)</th>
                          <th className="px-3 py-4 font-bold uppercase text-center w-24">Qty</th>
                          <th className="px-3 py-4 font-bold uppercase text-center w-24">Unit</th>
                          <th className="px-3 py-4 font-bold uppercase text-right w-32">Est. Unit Price</th>
                          <th className="px-3 py-4 font-bold uppercase text-right w-32 text-[#111f42]">Total Price</th>
                          <th className="px-3 py-4 font-bold uppercase w-48">Note/Brand</th>
                          {modalMode !== 'view' && <th className="px-3 py-4 font-bold uppercase text-center w-16">Act</th>}
                        </tr>
                      </thead>
        ...
        <div className="p-5 bg-slate-50 border-t border-slate-200 flex justify-between items-center shrink-0 px-8">
          ...
          {modalMode === 'view' ? (
            <button onClick={()=>setModalMode('edit')} className="px-8 py-2.5 text-white rounded-lg font-bold shadow-md uppercase tracking-widest flex items-center gap-2 hover:opacity-90 transition-all bg-amber-500 text-[12px]">
              <Pencil size={14}/> Edit PR
            </button>
          ) : (
            <button onClick={handleSave} className="px-10 py-2.5 text-white rounded-lg font-bold shadow-md uppercase tracking-widest flex items-center gap-2 hover:opacity-90 transition-all bg-[#111f42] text-[12px]">
