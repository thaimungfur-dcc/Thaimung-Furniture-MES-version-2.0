    ...
    <div className="fixed inset-0 bg-[#111f42]/60 backdrop-blur-sm z-[110] flex items-center justify-center p-4 no-print">
      <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in duration-200 max-h-[95vh]">
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-slate-200 flex justify-center print:p-0 print:bg-white custom-scrollbar">
          <div className="bg-white p-10 shadow-md w-full max-w-[794px] min-h-[1123px] h-max flex flex-col print:shadow-none print:p-0 relative">
            ...
            <div className="flex-1 mb-8">
              <table className="w-full text-left text-[11px] border border-slate-200">
                <thead className="bg-[#111f42] text-white">
                  <tr>
                    <th className="px-3 py-4 border-r border-slate-600 w-10 text-center font-bold">#</th>
                    <th className="px-3 py-4 border-r border-slate-600 font-bold">Description (รายการสินค้า)</th>
                    <th className="px-3 py-4 border-r border-slate-600 w-16 text-center font-bold">Qty</th>
                    <th className="px-3 py-4 border-r border-slate-600 w-16 text-center font-bold">Unit</th>
                    <th className="px-3 py-4 border-r border-slate-600 w-24 text-right font-bold">Est. Price</th>
                    <th className="px-3 py-4 border-r border-slate-600 w-28 text-right font-bold">Total Amount</th>
                    <th className="px-3 py-4 w-32 font-bold">Note</th>
                  </tr>
                </thead>
        ...
        <div className="p-4 bg-white border-t flex justify-end gap-3 shrink-0 no-print">
          ...
          <button onClick={executePrint} className="px-8 py-2 bg-[#ab8a3b] text-white rounded-lg font-bold text-[12px] shadow-md uppercase flex items-center gap-2 hover:bg-[#8f712c] transition-colors"><Printer size={16}/> Print PR</button>
        </div>
      </div>
    </div>
  );
