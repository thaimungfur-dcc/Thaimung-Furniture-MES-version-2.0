          ...
          <DraggableWrapper>
                <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in duration-200 max-h-[90vh]">
                  ...
                  <div className="p-4 bg-white border-t flex justify-end gap-3 shrink-0 no-print">
                    ...
                    <button onClick={executePrint} className="px-5 py-2 bg-[#ab8a3b] text-white rounded-lg font-bold text-[12px] shadow-md uppercase flex items-center gap-2 hover:bg-[#8f712c] transition-colors"><Printer size={16}/> Print PO</button>
                  </div>
                </div>
              </DraggableWrapper>
