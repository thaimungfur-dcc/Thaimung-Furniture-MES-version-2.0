  ...
  return (
    <div className="fixed inset-0 bg-[#111f42]/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4 no-print animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col max-h-[95vh]">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar bg-slate-50/30 space-y-6">
        ...
        <div className="p-5 bg-slate-50 border-t border-slate-200 flex justify-between items-center shrink-0 px-8">
          ...
          <div className="flex gap-2">
            {modalMode === 'view' ? (
              ...
              <button onClick={()=>updatePOStatus('Approved')} className="px-8 py-2 text-white rounded-lg font-bold shadow-md uppercase tracking-widest flex items-center gap-2 hover:opacity-90 transition-all bg-[#849a28] text-[12px]">
                <Stamp size={14}/> Approve PO
              </button>
            ) : (
              <button onClick={handleSavePO} className="px-10 py-2.5 text-white rounded-lg font-bold shadow-md uppercase tracking-widest flex items-center gap-2 hover:opacity-90 transition-all bg-[#111f42] text-[12px]">
