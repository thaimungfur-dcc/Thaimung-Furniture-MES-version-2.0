    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#111f42] text-white">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="font-mono text-sm uppercase tracking-widest">Loading Google Auth...</p>
        </div>
      </div>
    );
  }
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#111f42] text-white p-6">
        <div className="max-w-md w-full bg-white/5 backdrop-blur-xl p-10 rounded-[32px] border border-white/10 shadow-2xl text-center">
          <div className="w-20 h-20 bg-white/10 rounded-3xl flex items-center justify-center mx-auto mb-8 border border-white/20 shadow-inner">
          ...
          <h1 className="text-2xl font-black mb-4 uppercase tracking-tighter">ERP Google Sheets</h1>
          <p className="text-slate-400 text-sm mb-10 font-medium">Please sign in with Google to access and store your ERP data in Google Sheets.</p>
          <button 
            onClick={login}
            className="w-full bg-white text-[#111f42] py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-slate-100 transition-all shadow-xl active:scale-95"
          >
            Sign in with Google
          </button>
